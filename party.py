...
def most_and_least_common_type(treats):
    ...
    >>> treats = [{'type': 'fruits'},{'type': 'drink'},{'type': 'dessert'},
    ... {'type': 'dessert'}, {'type': 'fruits'},{'type': 'cheese'}]
    >>> most_and_least_common_type(treats)
    ('fruits', 'drink')
    ...
    most_count = most_type = None #returns None
    least_count = least_type = None #return None 

    # Find most, least common
    for treat_type, count in types.items(): # {"dessert":3, "appetizer":2, "drink":1}
